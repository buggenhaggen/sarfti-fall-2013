...
2. Задание №2
 а. Прочитать из каких основных блоков состоит компьютер, центральный процессор.
 б. Создать учетную запись (аккаунт) на github.org. Прислать мне письмо с именем учетной записи. Создать каталог с названием \<1-я буква имени><фамилия>/task_2
 в. Создать там файл notes.txt. В него включить ссылки на прочитанные материалы и краткую рецензию, о прочитанном.
3. Задание №3
 а. Какие бывают парадигмы программирования. Прочитать и мочь объяснить.
 б. Восстановить понятия объекта и класса из лекций по C++
 в. Написать на python скрипт вызывающий функций say_hallo, которая печатает "hello world!"
